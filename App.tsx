...
const App: React.FC = () => {
  ...
  const generateWorkoutPlan = useCallback(async (options: {
    ...
    prompt += "5.  **Rest Periods:** You MUST add a separate exercise object named 'Rest' with its own duration after each work exercise in the 'Main Workout' and 'Core Finisher' phases. For the 'Main Workout' phase, use exactly '15 seconds' rest between exercises. Do not add rest in the 'Warm-up' or 'Cool-down' phases.\n";
